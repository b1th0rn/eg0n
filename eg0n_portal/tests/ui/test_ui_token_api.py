...
def test_ui_authentication_token_api_admin(api_client, user_set):
...
def test_ui_authentication_token_api_staff(api_client, user_set):
...
def test_ui_authentication_token_api_user(api_client, user_set):
...
def test_ui_authentication_token_api_guest(api_client, user_set):
