...
def test_ui_authentication_token_create_api_admin(api_client, user_sets):
...
def test_ui_authentication_token_create_api_staff(api_client, user_sets):
...
def test_ui_authentication_token_create_api_user(api_client, user_sets):
