...
def test_ui_user_list_api_admin(api_client, user_sets):
    """
...
def test_ui_user_list_api_staff(api_client, user_sets):
    """
...
def test_ui_user_list_api_user(api_client, user_sets):
    """
...
def test_ui_user_list_api_guest(api_client, user_sets):
...
def test_ui_user_detail_api_admin(api_client, user_sets):
    """
...
def test_ui_user_detail_api_staff(api_client, user_sets):
    """
...
def test_ui_user_detail_api_user(api_client, user_sets):
    """
...
def test_ui_user_detail_api_guest(api_client, user_sets):
