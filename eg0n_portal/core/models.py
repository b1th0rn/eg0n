...
class BaseConfig(models.Model):
    ...
    author = models.CharField(max_length=32, editable=False, default=None, null=True)
    lastchange_author = models.CharField(max_length=32, editable=False, default=None, null=True)
    def __str__(self):
